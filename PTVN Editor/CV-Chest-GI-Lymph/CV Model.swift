...
struct Cardiovascular:PopulateComboBoxProtocol {
	...
	func processSectionFrom(_ data: [(Int, String?)]) -> String {
		...
		for item in data {
            ...
            case 8: resultArray.append("no bruits")
			case 10: resultArray.append("premature beat")
			case 11: resultArray.append("regularly irregular")
			case 12: resultArray.append("irregularly irregular")
			case 13: resultArray.append("tachycardia")
			case 14: resultArray.append("bradycardia")
            case 15: resultArray.append("right carotid bruit")
            case 16: resultArray.append("left carotid bruit")
			case 17: resultArray.append("s3 present")
			case 18: resultArray.append("s4 present")
